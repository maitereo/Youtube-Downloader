...
def main():
    ...
    yt = YouTube('https://www.youtube.com/watch?v=Sq1QZB5baNw') # Toward Total Scene Understanding for Autonomous Driving—Drago Anguelov (Waymo)
    ...
    # yt.streams.filter(resolution='2160p').desc().first().download()
